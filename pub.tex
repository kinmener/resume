...
\begin{myenumerate}
    \item \myname{Wei-Lun Hung} and Vijay K. Garg. ``Automatic-Signal Monitors
      with Multi-Object Synchronization.'' {\it IEEE International Parallel and 
    Distributed Processing Symposium (IPDPS)}, May.~2017. 

    \item \myname{Wei-Lun Hung}, Himanshu Chauhan, and Vijay K. Garg. ``
    ...
    \item \myname{Wei-Lun Hung}, Himanshu Chauhan, and Vijay K. Garg. ``Brief
